...
func main() {
	post := Post{Content: "Helloooooo world", Author: "hohohahahahahhahaha"}
	post.Create()

	comment := Comment{Content: "goooog comment", Author: "sdasdfasdfasd", Post:&post}
	comment.Create()
